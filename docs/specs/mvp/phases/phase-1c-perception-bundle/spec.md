...
delta:
  v0_2:
    ...
    changed:
      ...
      - AC-09 + R-09 — closed 12-code WarningCode enum (= 9 base: SETTLE_TIMEOUT_5S, SHADOW_DOM_NOT_TRAVERSED, IFRAME_SKIPPED, FONTS_NOT_READY, ANIMATION_NOT_SETTLED, COOKIE_BANNER_BLOCKING_FOLD, AUTH_REQUIRED_DETECTED, ELEMENT_GRAPH_TRUNCATED, EXTENSION_OUTPUT_MISSING + 3 iframe security-sensitive: CAPTCHA_DETECTED, CMP_DETECTED, PAYMENT_3DS_DETECTED)
