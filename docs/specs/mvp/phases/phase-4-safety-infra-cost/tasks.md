...
- [ ] **T-PHASE4-TESTS [P] [SETUP]** Author all **17 conformance tests** + Phase 4 integration test FIRST. **AC-01..AC-17** + adapter boundary test FAIL initially. R3.1 enforcement.
