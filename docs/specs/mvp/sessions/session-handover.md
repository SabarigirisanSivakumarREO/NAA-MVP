...
**Total remaining: 4 tasks** (1 T-SKELETON-010 + 3 demo prep + 1 Wednesday demo). T-SKELETON-001 through T-SKELETON-009 done. ~10-15 min focused work for T-SKELETON-010 (real Playwright Test acceptance — gate for Wednesday demo) plus demo-prep items remaining.
