...
**Total remaining: 7 tasks** (4 T-SKELETON-007..010 + 3 demo prep + 1 Wednesday demo). T-SKELETON-001 through T-SKELETON-006 done. ~30 min focused work remaining in Session 10 at one-by-one cadence; T-SKELETON-007..009 follow the T-SKELETON-005/006 fast-confirmation pattern (placeholders meet spec; each adds unit test + minor telemetry + forward-path docstring).
