...
**Total remaining: 6 tasks** (3 T-SKELETON-008..010 + 3 demo prep + 1 Wednesday demo). T-SKELETON-001 through T-SKELETON-007 done. ~20 min focused work remaining in Session 10 at one-by-one cadence; T-SKELETON-008/009 follow the fast-confirmation pattern (placeholders meet spec; each adds unit test + minor telemetry + forward-path docstring).
