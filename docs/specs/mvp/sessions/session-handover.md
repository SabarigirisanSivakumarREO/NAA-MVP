...
**Total remaining: 4 tasks** (3 demo prep + 1 Wednesday demo). **★ T-SKELETON-001 through T-SKELETON-010 ALL DONE — Walking-skeleton 10/10 COMPLETE ★**. Wednesday demo gate (T-SKELETON-010 acceptance suite) PASSED via `pnpm test:integration` 12/12 green. ~30-60 min for demo-prep items (pin Peregrine URL in demo script + author docs/specs/mvp/demo-scripts/wk-01.md + capture happy-path screenshots) plus Wednesday demo execution.
