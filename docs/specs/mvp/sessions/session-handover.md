...
**Total remaining: 8 tasks** (5 T-SKELETON-006..010 + 3 demo prep + 1 Wednesday demo). T-SKELETON-001 through T-SKELETON-005 done. ~45 min focused work remaining in Session 10 at one-by-one cadence; T-SKELETON-006..009 follow the T-SKELETON-005 fast-confirmation pattern (placeholders meet spec; each adds unit test + minor telemetry + forward-path docstring).
