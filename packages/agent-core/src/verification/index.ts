 ...
 *
 * Currently re-exports T051 + T052 shared types; T053-T065 implementation
 * modules (strategies, engine, classifier, scorer) extend this barrel as
 * they land in Wave 3+ (R18 append-only).
 */
